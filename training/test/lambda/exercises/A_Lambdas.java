...
public class A_Lambdas {
    ...
    public void a_predicate4() {
        ...
        Predicate<String> startsWithJAndLengthIs7 = s -> startsWithJ.test(s) && lengthIs7.test(s); // TODO
    ...
    public void a_predicate5() {
        ...
        Predicate<String> lengthIs9orError = s -> lengthIs9.test(s) || equalsError.test(s); // TODO
    ...
    public void b_function4() {
        ...
        Function<String, Integer> lengthBis = s -> unNullify.andThen(length).apply(s);
//        Function<String, Integer> lengthBis =s -> length.compose(unNullify).apply(s);
    ...
    public void c_consumer2() {
        Consumer<List<String>> cons = strings -> strings.clear();
